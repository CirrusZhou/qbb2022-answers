...
ax.title.set_text("The relationship between Father age and number of Paternal mutations")
...
ax.legend()
ax.title.set_text("number of paternal and maternal mutations in individuals ")
