...
ax.title.set_text("the relationship between mother age and number of paternal mutations")
...
ax.legend()
ax.title.set_text("number of maternal and maternal mutations in individuals ")
